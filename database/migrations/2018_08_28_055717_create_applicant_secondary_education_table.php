...
class CreateApplicantSecondaryEducationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('applicant_secondary_education', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('applicant_secondary_education');
    }
}
