...
class CreateApplicantHigherEducationLogTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('applicant_higher_education_logs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('applicant_higher_education_logs');
    }
}
