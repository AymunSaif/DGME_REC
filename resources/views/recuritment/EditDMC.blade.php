                                ...
                                <div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-2">
                                            ...
                                            <span style="font-size:11px;">{{$applicant->ApplicantDetail->age}} Years Old</span>
                                        </div>
                                        <div class="col-md-2">
                                                    ...
                                                    <div class="card-body table-full-width">
                                                        <table id="bootstrap-table" class="table">
                                                            ...
                                                            @elseif($applicant_higherEdu->bach_year=='4 years')
                                                              <input type="hidden" name="bach_year" value="2 years">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if($applicant_higherEdu->final_dmc_date==NULL)
                                                                          <input type="date" class="form-control" name="final_dmc_date" value="">
                                                                        @else
                                                                    ...
                                                                    <td>
                                                                      ...
                                                                      @if($applicant_higherEdu->final_dmc_date==NULL)
                                                                        <span><button class="btn btn-success update" type="button" data-id="{{$applicant_higherEdu->id}}">Update</button></span>
                                                                      @endif
                                                                    </td>
                                                                ...
                                                                @if($applicant_higherEdu->qualification_type=='phd')
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <tr  style="background-color:gray; color:black;" >
                                                                            ...
                                                                            <th  style="text-align:center;">Degree</th>
                                                                            <th colspan="4" style="text-align:center;">Thesis Topic</th>
                                                                            <th colspan="2" style="text-align:center;">Date of Graduation</th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2">
                                                                            @if($applicant_higherEdu->date_of_grad==NULL || $applicant_higherEdu->date_of_grad=='NA')
                                                                              <input type="date" name="date_of_grad" class="form-control" value="">
                                                                              <span><button class="btn btn-success update" type="button" date-id="{{$applicant_higherEdu->id}}">Update</button></span>
                                                                            {{-- <b style="color:red;">Not Available</b> --}}
                                                                            @else
                                                                            {{$applicant_higherEdu->date_of_grad}}
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                                @endif
...
@section('scriptTags')
  <script type="text/javascript">
    $('.update').click(function(){
        ...
        var final_dmc_date='';
        var date_of_grad='';
        if($(this).parent().parent().parent().children().find('input[name="final_dmc_date"]').length)
        {
          final_dmc_date=$(this).parent().parent().parent().children().find('input[name="final_dmc_date"]').val();
        }
        else {
            date_of_grad=$(this).parent().parent().parent().children().find('input[name="date_of_grad"]').val();
        }
        $.ajax({
            method: "POST",
            url: "/AddDMC",
            data: {
              "_token": "{{ csrf_token() }}",
               "applicant_higher_id": $(this).data("id"),
               "final_dmc": final_dmc_date,
               "date_grad": date_of_grad
             }
          })
          .done(function( msg ) {
            if(msg=="Saved")
