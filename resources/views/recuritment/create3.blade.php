        ...
        <tr class="ourTr_0">
            ...
            <td>
             ...
             <span class="dmc" style="display:none">Final DMC Date<br>
                ...
                <td> <input type="button" id="addline" value="Add Another Line"></td> 
...
$('.college_level').on('change',function(){ 
    ...
    $('tbody>tr>td').on('change','select.educationYear',function(){
        console.log('sa');
        if($(this).val()=='2 years')
        { 
        $(this).parent().parent().parent().next().find('.foury_cgpa').hide(1000);
        $(this).parent().parent().parent().next().find('.grad_d').hide(1000);
        $(this).parent().parent().parent().next().find('.dmc').hide(1000);

        $(this).parent().parent().parent().next().find('.univ_name').show(1000);
        $(this).parent().parent().parent().next().find('.univ_subjects').show(1000);
        $(this).parent().parent().parent().next().find('.twoy_totalmarks').show(1000);
        $(this).parent().parent().parent().next().find('.twoy_achievedmarks').show(1000)
        $(this).parent().parent().parent().next().find('.twoy_divi').show(1000);
        $(this).parent().parent().parent().next().find('.univ_dist').show(1000);
       
      }else if($(this).val()=='4 years')
            {
                $(this).parent().parent().parent().next().find('.twoy_totalmarks').hide(1000);
                $(this).parent().parent().parent().next().find('.twoy_achievedmarks').hide(1000)
                $(this).parent().parent().parent().next().find('.twoy_divi').hide(1000); 

                $(this).parent().parent().parent().next().find('.univ_name').show(1000);
                $(this).parent().parent().parent().next().find('.univ_subjects').show(1000);
                $(this).parent().parent().parent().next().find('.foury_cgpa').show(1000); 
                $(this).parent().parent().parent().next().find('.grad_d').show(1000);
                $(this).parent().parent().parent().next().find('.dmc').show(1000);
                $(this).parent().parent().parent().next().find('.univ_dist').show(1000);
            }
    });
          ...
          if(length == 5 || length == 13)
           $(this).val($(this).val()+'-');
              ...
              $('#addline').click(function() {
                  $('.ourTr_0').each(function(){
                    var ourtr=$(this).clone();
                    ourtr.find(`input#addline`).replaceWith(``);
                    console.log(ourtr);
                    ourtr.insertBefore('.nextTr');
                  });
            });
</script>
@endsection